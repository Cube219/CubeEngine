...
namespace cube
{
    ...
    inline Quaternion Quaternion::operator*(const Quaternion& rhs) const
    {
        ...
        const __m128 sign1 = _mm_set_ps(-1.0f, 1.0f, -1.0f, 1.0f);  // lanes (x,y,z,w) = (+,-,+,-)
        ...
        res = _mm_add_ps(res, _mm_mul_ps(x1, _mm_mul_ps(q2_1, sign1)));
        res = _mm_add_ps(res, _mm_mul_ps(y1, _mm_mul_ps(q2_2, sign2)));
        res = _mm_add_ps(res, _mm_mul_ps(z1, _mm_mul_ps(q2_3, sign3)));
