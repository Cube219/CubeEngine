...
namespace cube
{
    ...
    inline bool Matrix::IsAffine() const
    {
        ...
        return (d0 * d0 + d1 * d1 + d2 * d2 + d3 * d3) < kEps * kEps;
    }

    inline void Matrix::AffineInverse()
    {
        // Invert 3x3 upper-left block using cofactors
        float a00 = mRows[0].mData[0], a01 = mRows[0].mData[1], a02 = mRows[0].mData[2];
        float a10 = mRows[1].mData[0], a11 = mRows[1].mData[1], a12 = mRows[1].mData[2];
        float a20 = mRows[2].mData[0], a21 = mRows[2].mData[1], a22 = mRows[2].mData[2];
        ...
        float i00 = c00 * rDet, i01 = c10 * rDet, i02 = c20 * rDet;
        float i10 = c01 * rDet, i11 = c11 * rDet, i12 = c21 * rDet;
        float i20 = c02 * rDet, i21 = c12 * rDet, i22 = c22 * rDet;

        // New translation: t' = -t * A^(-1)
        float tx = mRows[3].mData[0], ty = mRows[3].mData[1], tz = mRows[3].mData[2];
        float ntx = -(tx * i00 + ty * i10 + tz * i20);
        float nty = -(tx * i01 + ty * i11 + tz * i21);
        float ntz = -(tx * i02 + ty * i12 + tz * i22);

        mRows[0].mData[0] = i00; mRows[0].mData[1] = i01; mRows[0].mData[2] = i02; mRows[0].mData[3] = 0.0f;
        mRows[1].mData[0] = i10; mRows[1].mData[1] = i11; mRows[1].mData[2] = i12; mRows[1].mData[3] = 0.0f;
        mRows[2].mData[0] = i20; mRows[2].mData[1] = i21; mRows[2].mData[2] = i22; mRows[2].mData[3] = 0.0f;
        mRows[3].mData[0] = ntx; mRows[3].mData[1] = nty; mRows[3].mData[2] = ntz; mRows[3].mData[3] = 1.0f;
    }
