...
namespace cube
{
    ModelLoaderSubsystem_glTF::ModelLoaderSubsystem_glTF()
        : ModelLoaderSubsystem("glTF Sample Asset")
    {
    }
    ...
    ModelResources ModelLoaderSubsystem_glTF::LoadModel(const ModelPathInfo& pathInfo)
    {
        CHECK(pathInfo.pathList.size() == 1);
        ...
        AnsiString pathStr;
        String_ConvertAndAppend(pathStr, pathInfo.pathList[0]);
