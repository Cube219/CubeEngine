...
namespace cube
{
    ...
    public:
        ...
        virtual bool IsNeededToOptimizeTextureContentsUsingCommandList() const override { return false; }
        ...
        virtual SharedPtr<gapi::Texture> CreateTexture(const gapi::TextureCreateInfo& createInfo) override;
